...
class MissionTracker(Node):
    def __init__(self):
        super().__init__("thermal_hud")

        # Parameters
        self.declare_parameter(
            "goals_file",
            "/home/yg5d6/spot_ws/src/spot_navigation/config/target_goals.yaml",
        )
        self.declare_parameter(
            "output_dir", "/home/yg5d6/spot_ws/src/spot_navigation/logs"
        )
        ...
        self.annotated_image_pub = self.create_publisher(
            Image, "/thermal/image_annotated", 10
        )
    ...
    def load_locations(self, goals_file):
        ...
        self.entrance = {"name": "Entrance", "position": [6.22024, -6.27788, 0.0]}
    ...
    def log_callback(self):
        ...
        self.latest_distances = {
            ...
            "goals": {
                self.goals[i]["name"]: distances[i] for i in range(len(self.goals))
            },
    ...
    def image_callback(self, msg):
        ...
        try:
            ...
            for i, line in enumerate(lines):
                ...
                cv2.putText(
                    cv_image, line, (10, y), cv2.FONT_HERSHEY_SIMPLEX, 0.6, (0, 0, 0), 4
                )
                # Draw white text
                cv2.putText(
                    cv_image,
    ...
    def publish_markers(
        self, robot_pos, nearest_goal, nearest_dist, dist_entrance, distances
    ):
